...
Version  : 1.26
Release  : 15
URL      : https://git.kernel.org/pub/scm/devel/pahole/pahole.git/snapshot/pahole-1.26.tar.gz
Source0  : https://git.kernel.org/pub/scm/devel/pahole/pahole.git/snapshot/pahole-1.26.tar.gz
...
%prep
%setup -q -n pahole-1.26
cd %{_builddir}
tar xf %{_sourcedir}/libbpf-1.0.0.tar.gz
cd %{_builddir}/pahole-1.26
mkdir -p lib/bpf
cp -r %{_builddir}/libbpf-1.0.0/* %{_builddir}/pahole-1.26/lib/bpf
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709219782
mkdir -p clr-build
pushd clr-build

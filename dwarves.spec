...
Version  : 1.20
Release  : 8
URL      : https://git.kernel.org/pub/scm/devel/pahole/pahole.git/snapshot/pahole-1.20.tar.gz
Source0  : https://git.kernel.org/pub/scm/devel/pahole/pahole.git/snapshot/pahole-1.20.tar.gz
Source1  : https://github.com/libbpf/libbpf/archive/5af3d86b5a2c5fecdc3ab83822d083edd32b4396/libbpf-0.2-12-g5af3d86.tar.gz
...
%prep
%setup -q -n pahole-1.20
cd %{_builddir}
tar xf %{_sourcedir}/libbpf-0.2-12-g5af3d86.tar.gz
cd %{_builddir}/pahole-1.20
mkdir -p lib/bpf
cp -r %{_builddir}/libbpf-5af3d86b5a2c5fecdc3ab83822d083edd32b4396/* %{_builddir}/pahole-1.20/lib/bpf
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612543467
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libbpf-5af3d86b5a2c5fecdc3ab83822d083edd32b4396/LICENSE.BSD-2-Clause %{buildroot}/usr/share/package-licenses/dwarves/34c5034377edef1080538bd0d4f5cf9b78e22dff
cp %{_builddir}/libbpf-5af3d86b5a2c5fecdc3ab83822d083edd32b4396/LICENSE.LPGL-2.1 %{buildroot}/usr/share/package-licenses/dwarves/91c66db733cf0ff2b3216ec4223b940daf6b26d4
cp %{_builddir}/pahole-1.20/COPYING %{buildroot}/usr/share/package-licenses/dwarves/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
pushd clr-build
%make_install
popd
...
/usr/share/package-licenses/dwarves/34c5034377edef1080538bd0d4f5cf9b78e22dff

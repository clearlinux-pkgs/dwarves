...
Source0  : https://git.kernel.org/pub/scm/devel/pahole/pahole.git/snapshot/pahole-1.19.tar.gz
...
%prep
%setup -q -n pahole-1.19
cd %{_builddir}
tar xf %{_sourcedir}/libbpf-0.2-12-g5af3d86.tar.gz
cd %{_builddir}/pahole-1.19
mkdir -p lib/bpf
cp -r %{_builddir}/libbpf-5af3d86b5a2c5fecdc3ab83822d083edd32b4396/* %{_builddir}/pahole-1.19/lib/bpf
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609353795
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/pahole-1.19/COPYING %{buildroot}/usr/share/package-licenses/dwarves/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
pushd clr-build
%make_install
popd

...
Source0  : https://git.kernel.org/pub/scm/devel/pahole/pahole.git/snapshot/pahole-1.21.tar.gz
Source1  : https://github.com/libbpf/libbpf/archive/986962fade5dfa89c2890f3854eb040d2a64ab3/libbpf-0.3-42-g986962f.tar.gz
...
%prep
%setup -q -n pahole-1.21
cd %{_builddir}
tar xf %{_sourcedir}/libbpf-0.3-42-g986962f.tar.gz
cd %{_builddir}/pahole-1.21
mkdir -p lib/bpf
cp -r %{_builddir}/libbpf-986962fade5dfa89c2890f3854eb040d2a64ab38/* %{_builddir}/pahole-1.21/lib/bpf
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618606896
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libbpf-986962fade5dfa89c2890f3854eb040d2a64ab38/LICENSE.BSD-2-Clause %{buildroot}/usr/share/package-licenses/dwarves/34c5034377edef1080538bd0d4f5cf9b78e22dff
cp %{_builddir}/libbpf-986962fade5dfa89c2890f3854eb040d2a64ab38/LICENSE.LGPL-2.1 %{buildroot}/usr/share/package-licenses/dwarves/91c66db733cf0ff2b3216ec4223b940daf6b26d4
cp %{_builddir}/pahole-1.21/COPYING %{buildroot}/usr/share/package-licenses/dwarves/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
pushd clr-build
%make_install
popd

...
Source0  : https://git.kernel.org/pub/scm/devel/pahole/pahole.git/snapshot/pahole-1.17.tar.gz
Source1  : https://github.com/libbpf/libbpf/archive/e5dbc1a96f138e7c47324a65269adff0ca0f4f6e/libbpf-0.0.6-80-ge5dbc1a.tar.gz
...
%prep
%setup -q -n pahole-1.17
cd %{_builddir}
tar xf %{_sourcedir}/libbpf-0.0.6-80-ge5dbc1a.tar.gz
cd %{_builddir}/pahole-1.17
mkdir -p lib/bpf
cp -r %{_builddir}/libbpf-e5dbc1a96f138e7c47324a65269adff0ca0f4f6e/* %{_builddir}/pahole-1.17/lib/bpf
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586920902
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libbpf-e5dbc1a96f138e7c47324a65269adff0ca0f4f6e/LICENSE.BSD-2-Clause %{buildroot}/usr/share/package-licenses/dwarves/34c5034377edef1080538bd0d4f5cf9b78e22dff
cp %{_builddir}/libbpf-e5dbc1a96f138e7c47324a65269adff0ca0f4f6e/LICENSE.LPGL-2.1 %{buildroot}/usr/share/package-licenses/dwarves/91c66db733cf0ff2b3216ec4223b940daf6b26d4
cp %{_builddir}/pahole-1.17/COPYING %{buildroot}/usr/share/package-licenses/dwarves/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
pushd clr-build
%make_install
popd

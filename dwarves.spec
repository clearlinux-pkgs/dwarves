...
Source0  : https://git.kernel.org/pub/scm/devel/pahole/pahole.git/snapshot/pahole-1.30.tar.gz
...
%prep
%setup -q -n pahole-1.30
cd %{_builddir}
tar xf %{_sourcedir}/libbpf-1.0.0.tar.gz
cd %{_builddir}/pahole-1.30
mkdir -p lib/bpf
cp -r %{_builddir}/libbpf-1.0.0/. %{_builddir}/pahole-1.30/lib/bpf
pushd ..
cp -a pahole-1.30 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745270083
mkdir -p clr-build
pushd clr-build

...
Source0  : https://git.kernel.org/pub/scm/devel/pahole/pahole.git/snapshot/pahole-1.18.tar.gz
...
%prep
%setup -q -n pahole-1.18
cd %{_builddir}
tar xf %{_sourcedir}/libbpf-0.0.6-80-ge5dbc1a.tar.gz
cd %{_builddir}/pahole-1.18
mkdir -p lib/bpf
cp -r %{_builddir}/libbpf-e5dbc1a96f138e7c47324a65269adff0ca0f4f6e/* %{_builddir}/pahole-1.18/lib/bpf
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602182871
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/pahole-1.18/COPYING %{buildroot}/usr/share/package-licenses/dwarves/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
pushd clr-build
%make_install
popd

...
Version  : 1.22
Release  : 10
URL      : https://git.kernel.org/pub/scm/devel/pahole/pahole.git/snapshot/pahole-1.22.tar.gz
Source0  : https://git.kernel.org/pub/scm/devel/pahole/pahole.git/snapshot/pahole-1.22.tar.gz
...
%prep
%setup -q -n pahole-1.22
cd %{_builddir}
tar xf %{_sourcedir}/libbpf-0.3-42-g986962f.tar.gz
cd %{_builddir}/pahole-1.22
mkdir -p lib/bpf
cp -r %{_builddir}/libbpf-986962fade5dfa89c2890f3854eb040d2a64ab38/* %{_builddir}/pahole-1.22/lib/bpf
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629741948
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/pahole-1.22/COPYING %{buildroot}/usr/share/package-licenses/dwarves/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
pushd clr-build
%make_install
popd

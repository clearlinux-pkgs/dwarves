...
Source0  : https://git.kernel.org/pub/scm/devel/pahole/pahole.git/snapshot/pahole-1.23.tar.gz
Source1  : https://github.com/libbpf/libbpf/archive/94a49850c5ee61ea02dfcbabf48013391e8cecdf/libbpf-0.5.0-154-g94a4985.tar.gz
...
%prep
%setup -q -n pahole-1.23
cd %{_builddir}
tar xf %{_sourcedir}/libbpf-0.5.0-154-g94a4985.tar.gz
cd %{_builddir}/pahole-1.23
mkdir -p lib/bpf
cp -r %{_builddir}/libbpf-94a49850c5ee61ea02dfcbabf48013391e8cecdf/* %{_builddir}/pahole-1.23/lib/bpf
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645057704
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libbpf-94a49850c5ee61ea02dfcbabf48013391e8cecdf/LICENSE.BSD-2-Clause %{buildroot}/usr/share/package-licenses/dwarves/34c5034377edef1080538bd0d4f5cf9b78e22dff
cp %{_builddir}/libbpf-94a49850c5ee61ea02dfcbabf48013391e8cecdf/LICENSE.LGPL-2.1 %{buildroot}/usr/share/package-licenses/dwarves/91c66db733cf0ff2b3216ec4223b940daf6b26d4
cp %{_builddir}/pahole-1.23/COPYING %{buildroot}/usr/share/package-licenses/dwarves/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
pushd clr-build
%make_install
popd

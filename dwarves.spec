...
Version  : 1.16
Release  : 4
URL      : https://git.kernel.org/pub/scm/devel/pahole/pahole.git/snapshot/pahole-1.16.tar.gz
Source0  : https://git.kernel.org/pub/scm/devel/pahole/pahole.git/snapshot/pahole-1.16.tar.gz
Source1  : https://github.com/libbpf/libbpf/archive/4d86cae4f09f3db67d6d0543f94546f85f7b2c38/libbpf-0.0.5-23-g4d86cae.tar.gz
...
Patch2: 0002-dwarves-Add-D_LARGEFILE64_SOURCE-D_FILE_OFFSET_BITS-.patch
...
%prep
%setup -q -n pahole-1.16
cd %{_builddir}
tar xf %{_sourcedir}/libbpf-0.0.5-23-g4d86cae.tar.gz
cd %{_builddir}/pahole-1.16
mkdir -p lib/bpf
cp -r %{_builddir}/libbpf-4d86cae4f09f3db67d6d0543f94546f85f7b2c38/* %{_builddir}/pahole-1.16/lib/bpf
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583375675
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/pahole-1.16/COPYING %{buildroot}/usr/share/package-licenses/dwarves/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
pushd clr-build
%make_install
popd
